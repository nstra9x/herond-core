...
const resetChromeStringFiles = () => {
  ...
  // overwritten with modified versions from ./src/herond during build.
...
const chromiumRebaseL10n = async (options) => {
  ...
  const removed = await l10nUtil.rebaseHerondStringFilesOnChromiumL10nFiles()
  l10nUtil.getHerondAutoGeneratedPaths().forEach((sourceStringPath) => {
